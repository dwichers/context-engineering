...
```bash
Glob **/*-initial-arg.md in arg/initial/
Glob **/*-feature-arg.md in arg/feature/
```

**Search for PRP documents**:
```bash
Glob **/*-initial-prp.md in prp/initial/
Glob **/*-feature-prp.md in prp/feature/
```
...
- Initial ARG: [✅/❌] arg/initial/[filename]
- Initial PRP: [✅/❌] prp/initial/[filename]
