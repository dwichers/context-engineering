...
This must be the path to the initial ARG document: `.claude/arg/initial/[filename].md`
...
1. **Determine feature number**:
   - Check `.claude/arg/feature/` for existing features
...
4. **Save Feature ARG**:
   ```
   Location: .claude/arg/feature/[number]-[feature-name]-feature-arg.md
...
1. .claude/arg/feature/001-[name]-feature-arg.md - [Priority: High]
2. .claude/arg/feature/002-[name]-feature-arg.md - [Priority: High]
3. .claude/arg/feature/003-[name]-feature-arg.md - [Priority: Medium]
...

Recommended Implementation Order:
1. Execute Initial PRP first (/execute-initial)
2. Then implement features in numbered order:
   - /generate-feature-prp .claude/arg/feature/001-...
   - /execute-feature .claude/prp/feature/001-...
...
1. **Read the PRP template**:
   ```bash
   Read .claude/prp/initial/template/initial-prp-template.md
   ```
...
2. **Save document**:
   ```
   Location: .claude/prp/initial/[filename].md
   ```
...
Inform user about:
```
✅ Initial PRP generated: .claude/prp/initial/[filename].md
...
1. .claude/arg/feature/001-[name]-feature-arg.md - [Priority]
2. .claude/arg/feature/002-[name]-feature-arg.md - [Priority]
3. .claude/arg/feature/003-[name]-feature-arg.md - [Priority]
...
PHASE 1 - Foundation:
/execute-initial .claude/prp/initial/[filename].md
...
For each feature:
  1. /generate-feature-prp .claude/arg/feature/[number]-[name]-feature-arg.md
  2. /execute-feature .claude/prp/feature/[number]-[name]-feature-prp.md
  3. Test & validate
...
**Generated from**: .claude/arg/initial/2024-03-15-task-management-initial-arg.md
