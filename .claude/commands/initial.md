...
Ask targeted questions to get a complete picture. Use the template `.claude/arg/initial/template/initial-arg-template.md` as a guide for what information is needed.
...
1. **Read the template**:
   ```bash
   Read .claude/arg/initial/template/initial-arg-template.md
   ```
...
4. **Save in correct location**:
   ```
   .claude/arg/initial/[generated-filename].md
   ```
...
```
✅ Initial ARG document generated: .claude/arg/initial/[filename].md

Next steps:
1. Review the document and fill in any open questions
2. Generate an Initial PRP with: /generate-initial-prp .claude/arg/initial/[filename].md
3. Execute the Initial PRP with: /execute-initial .claude/prp/initial/[prp-filename].md
```
...
AI: ✅ Initial ARG document generated: .claude/arg/initial/2024-03-15-task-management-initial-arg.md
...
Next step:
/generate-initial-prp .claude/arg/initial/2024-03-15-task-management-initial-arg.md
```
...
- [ ] Document is saved in .claude/arg/initial/
